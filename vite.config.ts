    ...
    monkey({
      ...
      userscript: {
        ...
        description: {
          ...
          en: 'Download artworks with one click. Batch download artworks or download by tags. Convert ugoira formats: Gif | Apng | Webp | Webm | MP4. Customize image file name, save path. Save / export download history. Pixiv | Danbooru | ATFbooru | Yande.re | Konachan | Sakugabooru | Rule34 | Gelbooru | Safebooru | E621 | E926 | E6ai | Nijie.info'
        },
        match: [
          'https://www.pixiv.net/*',
          'https://rule34.xxx/*',
